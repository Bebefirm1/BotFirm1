...
# ═══════════════════════════════════════════════════════════
#  AIDE — /help & /help <commande>
# ═══════════════════════════════════════════════════════════
COMMANDS_DETAIL = {
    "ticket":                   {"usage": "/ticket [raison]",                        "description": "Ouvre un ticket de support privé.",                                                              "args": [("raison", "Optionnel", "Décrit votre problème.")],                                                                                                                                              "perms": "Tout le monde",        "category": "🎫 Tickets"},
    "fermer":                   {"usage": "/fermer",                                 "description": "Ferme le ticket actuel (confirmation + 5s).",                                                     "args": [],                                                                                                                                                                                               "perms": "Tout le monde",        "category": "🎫 Tickets"},
    "ajouter":                  {"usage": "/ajouter <@user>",                        "description": "Ajoute un membre au ticket actuel.",                                                              "args": [("@user", "Requis", "Le membre à ajouter.")],                                                                                                                                                    "perms": "Tout le monde",        "category": "🎫 Tickets"},
    "retirer":                  {"usage": "/retirer <@user>",                        "description": "Retire un membre du ticket actuel.",                                                              "args": [("@user", "Requis", "Le membre à retirer.")],                                                                                                                                                    "perms": "Tout le monde",        "category": "🎫 Tickets"},
    "panel-tickets":            {"usage": "/panel-tickets",                          "description": "Envoie le panel d'ouverture de tickets.",                                                        "args": [],                                                                                                                                                                                               "perms": "Administrateur",       "category": "🎫 Tickets"},
    "config-tickets":           {"usage": "/config-tickets",                         "description": "Affiche la config des tickets (logs, rôles, catégories).",                                       "args": [],                                                                                                                                                                                               "perms": "Administrateur",       "category": "🎫 Tickets"},
    "set-log-tickets":          {"usage": "/set-log-tickets <#salon>",               "description": "Définit le salon de logs des tickets.",                                                          "args": [("#salon", "Requis", "Le salon cible.")],                                                                                                                                                        "perms": "Administrateur",       "category": "🎫 Tickets"},
    "ajouter-role-ticket":      {"usage": "/ajouter-role-ticket <@role>",            "description": "Ajoute un rôle à pinger à l'ouverture d'un ticket.",                                            "args": [("@role", "Requis", "Le rôle à ajouter.")],                                                                                                                                                      "perms": "Administrateur",       "category": "🎫 Tickets"},
    "retirer-role-ticket":      {"usage": "/retirer-role-ticket <@role>",            "description": "Retire un rôle de la liste des pings.",                                                          "args": [("@role", "Requis", "Le rôle à retirer.")],                                                                                                                                                      "perms": "Administrateur",       "category": "🎫 Tickets"},
    "ajouter-categorie-ticket": {"usage": "/ajouter-categorie-ticket <label> ...",   "description": "Ajoute une catégorie au menu de tickets.",                                                       "args": [("label","Requis","Nom affiché."),("categorie_discord","Requis","Catégorie Discord cible."),("description","Optionnel","Description courte."),("emoji","Optionnel","Emoji (défaut 🎫).")],         "perms": "Administrateur",       "category": "🎫 Tickets"},
    "retirer-categorie-ticket": {"usage": "/retirer-categorie-ticket <label>",       "description": "Supprime une catégorie du menu.",                                                                "args": [("label", "Requis", "Nom exact à supprimer.")],                                                                                                                                                  "perms": "Administrateur",       "category": "🎫 Tickets"},
    "reset-config-tickets":     {"usage": "/reset-config-tickets",                   "description": "Réinitialise toute la config tickets.",                                                          "args": [],                                                                                                                                                                                               "perms": "Administrateur",       "category": "🎫 Tickets"},
    "set-log-mod":              {"usage": "/set-log-mod <#salon>",                   "description": "Définit le salon de logs de modération (ban, kick, mute, automod…).",                           "args": [("#salon", "Requis", "Le salon cible.")],                                                                                                                                                        "perms": "Administrateur",       "category": "🔨 Modération"},
    "ban":                      {"usage": "/ban <@user> [raison]",                   "description": "Bannit un membre. Un MP lui est envoyé.",                                                        "args": [("@user","Requis","Le membre."),("raison","Optionnel","Raison.")],                                                                                                                                "perms": "Bannir des membres",   "category": "🔨 Modération"},
    "kick":                     {"usage": "/kick <@user> [raison]",                  "description": "Expulse un membre. Un MP lui est envoyé.",                                                       "args": [("@user","Requis","Le membre."),("raison","Optionnel","Raison.")],                                                                                                                                "perms": "Expulser des membres", "category": "🔨 Modération"},
    "mute":                     {"usage": "/mute <@user> <durée> [raison]",          "description": "Met un membre en sourdine (timeout). Formats : 10s, 5m, 2h, 1j. Max 28j.",                     "args": [("@user","Requis","Le membre."),("durée","Requis","Ex : 5m, 2h."),("raison","Optionnel","Raison.")],                                                                                              "perms": "Modérer les membres",  "category": "🔨 Modération"},
    "unmute":                   {"usage": "/unmute <@user>",                         "description": "Retire le timeout d'un membre.",                                                                 "args": [("@user", "Requis", "Le membre.")],                                                                                                                                                               "perms": "Modérer les membres",  "category": "🔨 Modération"},
    "warn":                     {"usage": "/warn <@user> <raison>",                  "description": "Avertit un membre. L'historique est sauvegardé.",                                               "args": [("@user","Requis","Le membre."),("raison","Requis","Raison.")],                                                                                                                                    "perms": "Expulser des membres", "category": "🔨 Modération"},
    "warns":                    {"usage": "/warns <@user>",                          "description": "Affiche l'historique des avertissements.",                                                       "args": [("@user", "Requis", "Le membre.")],                                                                                                                                                               "perms": "Expulser des membres", "category": "🔨 Modération"},
    "clear":                    {"usage": "/clear <nombre>",                         "description": "Supprime en masse des messages (1–100).",                                                        "args": [("nombre", "Requis", "Nombre de messages (1–100).")],                                                                                                                                            "perms": "Gérer les messages",   "category": "🔨 Modération"},
    "config-auto-mod":          {"usage": "/config-auto-mod",                        "description": "Affiche la config complète de l'auto-modération.",                                              "args": [],                                                                                                                                                                                               "perms": "Administrateur",       "category": "🤖 Auto-Modération"},
    "config-antispam":          {"usage": "/config-antispam [limite] [fenetre] [mute_minutes] [actif]", "description": "Personnalise l'antispam par serveur.",                                        "args": [("limite","Optionnel","Nb messages (2–50)."),("fenetre","Optionnel","Fenêtre en secondes (1–60)."),("mute_minutes","Optionnel","Durée du mute (1–1440)."),("actif","Optionnel","true/false.")],     "perms": "Administrateur",       "category": "🤖 Auto-Modération"},
    "ajouter-badword":          {"usage": "/ajouter-badword <mot(s)>",               "description": "Ajoute un ou plusieurs badwords séparés par _ (ex: mot1_mot2).",                               "args": [("mot(s)", "Requis", "Mots séparés par _.")],                                                                                                                                                    "perms": "Administrateur",       "category": "🤖 Auto-Modération"},
    "retirer-badword":          {"usage": "/retirer-badword <mot>",                  "description": "Retire un badword de la liste.",                                                                 "args": [("mot", "Requis", "Le mot à retirer.")],                                                                                                                                                         "perms": "Administrateur",       "category": "🤖 Auto-Modération"},
    "liste-badwords":           {"usage": "/liste-badwords",                         "description": "Affiche tous les badwords configurés.",                                                          "args": [],                                                                                                                                                                                               "perms": "Administrateur",       "category": "🤖 Auto-Modération"},
    "salon-no-lien":            {"usage": "/salon-no-lien [#salon]",                 "description": "Toggle l'interdiction de liens dans un salon.",                                                  "args": [("#salon", "Optionnel", "Salon cible (défaut : actuel).")],                                                                                                                                      "perms": "Administrateur",       "category": "🤖 Auto-Modération"},
    "salon-no-image":           {"usage": "/salon-no-image [#salon]",                "description": "Toggle l'interdiction d'images dans un salon.",                                                  "args": [("#salon", "Optionnel", "Salon cible (défaut : actuel).")],                                                                                                                                      "perms": "Administrateur",       "category": "🤖 Auto-Modération"},
    "whitelist-ajouter":        {"usage": "/whitelist-ajouter <@user>",              "description": "Ajoute un membre à la whitelist (bypass auto-mod).",                                            "args": [("@user", "Requis", "Le membre.")],                                                                                                                                                               "perms": "Administrateur",       "category": "🛡️ Whitelist & Blacklist"},
    "whitelist-retirer":        {"usage": "/whitelist-retirer <@user>",              "description": "Retire un membre de la whitelist.",                                                              "args": [("@user", "Requis", "Le membre.")],                                                                                                                                                               "perms": "Administrateur",       "category": "🛡️ Whitelist & Blacklist"},
    "whitelist-liste":          {"usage": "/whitelist-liste",                        "description": "Affiche tous les membres whitelistés.",                                                          "args": [],                                                                                                                                                                                               "perms": "Administrateur",       "category": "🛡️ Whitelist & Blacklist"},
    "blacklist-ajouter":        {"usage": "/blacklist-ajouter <@user> [raison]",     "description": "Blackliste un membre : expulsion immédiate + automatique à chaque rejoint.",                    "args": [("@user","Requis","Le membre."),("raison","Optionnel","Raison.")],                                                                                                                                "perms": "Administrateur",       "category": "🛡️ Whitelist & Blacklist"},
    "blacklist-retirer":        {"usage": "/blacklist-retirer <@user>",              "description": "Retire un membre de la blacklist.",                                                              "args": [("@user", "Requis", "Le membre (peut avoir quitté).")],                                                                                                                                          "perms": "Administrateur",       "category": "🛡️ Whitelist & Blacklist"},
    "blacklist-liste":          {"usage": "/blacklist-liste",                        "description": "Affiche tous les membres blacklistés.",                                                          "args": [],                                                                                                                                                                                               "perms": "Administrateur",       "category": "🛡️ Whitelist & Blacklist"},
    "pile-ou-face":             {"usage": "/pile-ou-face",                           "description": "Lance une pièce.",                                                                               "args": [],                                                                                                                                                                                               "perms": "Tout le monde",        "category": "🎮 Mini-Jeux"},
    "dé":                       {"usage": "/dé [faces]",                             "description": "Lance un dé (défaut : 6 faces).",                                                               "args": [("faces", "Optionnel", "Nombre de faces (min 2).")],                                                                                                                                             "perms": "Tout le monde",        "category": "🎮 Mini-Jeux"},
    "rps":                      {"usage": "/rps <choix>",                            "description": "Pierre-Papier-Ciseaux contre le bot.",                                                          "args": [("choix", "Requis", "pierre, papier ou ciseaux.")],                                                                                                                                              "perms": "Tout le monde",        "category": "🎮 Mini-Jeux"},
    "nombre":                   {"usage": "/nombre [max]",                           "description": "Devinez le nombre secret en 30s.",                                                              "args": [("max", "Optionnel", "Valeur max (défaut 100).")],                                                                                                                                               "perms": "Tout le monde",        "category": "🎮 Mini-Jeux"},
    "8ball":                    {"usage": "/8ball <question>",                       "description": "Posez une question à la boule magique.",                                                        "args": [("question", "Requis", "Votre question.")],                                                                                                                                                      "perms": "Tout le monde",        "category": "🎮 Mini-Jeux"},
    "trivia":                   {"usage": "/trivia",                                 "description": "Question de culture générale (QCM, 20s).",                                                      "args": [],                                                                                                                                                                                               "perms": "Tout le monde",        "category": "🎮 Mini-Jeux"},
    "ping":                     {"usage": "/ping",                                   "description": "Latence WebSocket du bot.",                                                                      "args": [],                                                                                                                                                                                               "perms": "Tout le monde",        "category": "🛠️ Utilitaires"},
    "info-serveur":             {"usage": "/info-serveur",                           "description": "Infos sur le serveur.",                                                                          "args": [],                                                                                                                                                                                               "perms": "Tout le monde",        "category": "🛠️ Utilitaires"},
    "info-user":                {"usage": "/info-user [@user]",                      "description": "Infos sur un membre.",                                                                           "args": [("@user", "Optionnel", "Défaut : vous-même.")],                                                                                                                                                  "perms": "Tout le monde",        "category": "🛠️ Utilitaires"},
    "avatar":                   {"usage": "/avatar [@user]",                         "description": "Avatar en haute résolution.",                                                                    "args": [("@user", "Optionnel", "Défaut : vous-même.")],                                                                                                                                                  "perms": "Tout le monde",        "category": "🛠️ Utilitaires"},
    "say":                      {"usage": "/say <message> [#salon]",                 "description": "Fait parler le bot à votre place.",                                                              "args": [("message","Requis","Message à envoyer."),("#salon","Optionnel","Salon cible.")],                                                                                                                "perms": "Administrateur",       "category": "🛠️ Utilitaires"},
    "renommer-bot":             {"usage": "/renommer-bot <nom>",                     "description": "Change le pseudo du bot sur ce serveur (max 2/heure).",                                         "args": [("nom", "Requis", "Nouveau pseudo (max 32 car.).")],                                                                                                                                             "perms": "Administrateur",       "category": "🛠️ Utilitaires"},
    "help":                     {"usage": "/help [commande]",                        "description": "Aide paginée ou détails d'une commande.",                                                       "args": [("commande", "Optionnel", "Nom de la commande.")],                                                                                                                                               "perms": "Tout le monde",        "category": "🛠️ Utilitaires"},
}

@tree.command(name="help", description="Aide complète ou détails d'une commande")
    ...
    if commande:
        ...
        if not info:
            await interaction.response.send_message(embed=firm1_embed(
                ...
                f"Aucune commande `/{key}`.\nUtilisez `/help` pour la liste complète.",
                color=COLOR_ERROR,
            ), ephemeral=True)
            return

        args_text = "\n".join(f"`{a}` — **{req}** — {desc}" for a, req, desc in info["args"]) if info["args"] else "*Aucun argument*"
        embed = discord.Embed(title=f"📖  /{key}", description=info["description"], color=COLOR_PRIMARY, timestamp=datetime.datetime.utcnow())
...
async def server_info(interaction: discord.Interaction):
    g = interaction.guild
    await interaction.response.send_message(embed=firm1_embed(
        f"Serveur — {g.name}", g.description or "Aucune description.", color=COLOR_INFO,
...
async def user_info(interaction: discord.Interaction, membre: discord.Member | None = None):
    ...
    await interaction.response.send_message(embed=firm1_embed(
        f"Utilisateur — {m.display_name}", f"**Tag :** {m}\n**ID :** `{m.id}`",
        color=COLOR_INFO, thumbnail=m.display_avatar.url,
        fields=[
...
@tree.command(name="avatar", description="Avatar d'un utilisateur")
...
async def rename_bot(interaction: discord.Interaction, nom: str):
    ...
    try:
        ...
        await interaction.response.send_message(embed=firm1_embed("✅ Pseudo mis à jour", f"Le bot s'appelle **{nom}** sur ce serveur.", color=COLOR_SUCCESS, fields=[("⚠️ Limite", "Max 2 changements par heure.", False)]), ephemeral=True)
...
async def _creer_ticket(interaction: discord.Interaction, raison: str = "Non spécifiée", category_id: int | None = None):
    ...
    if user.id in open_tickets:
        ...
        if ch:
            await interaction.response.send_message(embed=firm1_embed("Ticket déjà ouvert", f"Vous avez déjà un ticket : {ch.mention}", color=COLOR_WARNING), ephemeral=True)
            return
    ...
    open_tickets[user.id] = {"channel_id": channel.id, "created_at": datetime.datetime.utcnow().isoformat(), "reason": raison}

    embed = discord.Embed(title="🎫  Ticket ouvert", description=f"Bienvenue {user.mention} !\n\n> {raison}\n\nLe staff va vous répondre dès que possible.", color=COLOR_SUCCESS, timestamp=datetime.datetime.utcnow())
    ...
    await interaction.response.send_message(embed=firm1_embed("Ticket créé !", f"Votre ticket : {channel.mention}", color=COLOR_SUCCESS), ephemeral=True)
...
async def ajouter_cmd(interaction: discord.Interaction, membre: discord.Member):
    if not any(d["channel_id"] == interaction.channel.id for d in open_tickets.values()):
        await interaction.response.send_message(embed=firm1_embed("Erreur", "Utilisez cette commande dans un ticket.", color=COLOR_ERROR), ephemeral=True); return
...
async def config_tickets(interaction: discord.Interaction):
    ...
    cats_value = "\n".join(f"{c.get('emoji','🎫')} **{c['label']}** → {(interaction.guild.get_channel(c.get('discord_category_id')) or type('x',(),{'mention':'`défaut`'})()).mention}" for c in cfg.get("ticket_categories", [])) or "❌ Aucune"
    embed = discord.Embed(title="⚙️ Configuration — Tickets", color=COLOR_PRIMARY, timestamp=datetime.datetime.utcnow())
    ...
    embed.add_field(name="🗂️ Catégories", value=cats_value, inline=False)
...
async def add_ping_role(interaction: discord.Interaction, role: discord.Role):
    ...
    if role.id in ping_ids:
        await interaction.response.send_message(embed=firm1_embed("Déjà présent", f"{role.mention} est déjà dans la liste.", color=COLOR_WARNING), ephemeral=True); return
...
async def remove_ping_role(interaction: discord.Interaction, role: discord.Role):
    ...
    if role.id not in ping_ids:
        await interaction.response.send_message(embed=firm1_embed("Introuvable", f"{role.mention} n'est pas dans la liste.", color=COLOR_WARNING), ephemeral=True); return
...
async def add_ticket_category(interaction: discord.Interaction, label: str, categorie_discord: discord.CategoryChannel, description: str = "", emoji: str = "🎫"):
    ...
    if any(c["label"].lower() == label.lower() for c in categories):
        await interaction.response.send_message(embed=firm1_embed("Déjà existant", f"**{label}** existe déjà.", color=COLOR_WARNING), ephemeral=True); return
    if len(categories) >= 25:
        await interaction.response.send_message(embed=firm1_embed("Limite atteinte", "Maximum 25 catégories.", color=COLOR_ERROR), ephemeral=True); return
...
async def remove_ticket_category(interaction: discord.Interaction, label: str):
    ...
    if len(new_cats) == len(categories):
        await interaction.response.send_message(embed=firm1_embed("Introuvable", f"Aucune catégorie **{label}**.", color=COLOR_WARNING), ephemeral=True); return
...
async def reset_config_tickets(interaction: discord.Interaction):
    ...
    if gid in cfg:
        del cfg[gid]; _save_config(cfg)
    await interaction.response.send_message(embed=firm1_embed("🔄 Config réinitialisée", "Logs, rôles et catégories remis à zéro.\nUtilisez `/set-log-tickets` et `/ajouter-role-ticket` pour reconfigurer.", color=COLOR_WARNING), ephemeral=True)
...
async def panel_tickets(interaction: discord.Interaction):
    ...
    await interaction.response.send_message(embed=firm1_embed("✅ Panel envoyé !", "Le panel de tickets a été créé.", color=COLOR_SUCCESS, fields=[("📁 Logs", log_ch.mention if log_ch else "❌ Non configuré", True), ("🔔 Rôles", " ".join(r.mention for r in ping_roles) if ping_roles else "❌ Aucun", True)]), ephemeral=True)
...
async def ban_cmd(interaction: discord.Interaction, membre: discord.Member, raison: str = "Aucune raison fournie"):
    if membre.top_role >= interaction.user.top_role:
        await interaction.response.send_message(embed=firm1_embed("Erreur", "Rôle supérieur ou égal.", color=COLOR_ERROR), ephemeral=True); return
    try: await membre.send(embed=firm1_embed("🔨 Vous avez été banni", f"**Serveur :** {interaction.guild.name}\n**Raison :** {raison}", color=COLOR_ERROR))
...
async def kick_cmd(interaction: discord.Interaction, membre: discord.Member, raison: str = "Aucune raison fournie"):
    if membre.top_role >= interaction.user.top_role:
        await interaction.response.send_message(embed=firm1_embed("Erreur", "Rôle supérieur ou égal.", color=COLOR_ERROR), ephemeral=True); return
    try: await membre.send(embed=firm1_embed("👢 Vous avez été expulsé", f"**Serveur :** {interaction.guild.name}\n**Raison :** {raison}", color=COLOR_WARNING))
    except Exception: pass
...
async def mute_cmd(interaction: discord.Interaction, membre: discord.Member, duree: str, raison: str = "Aucune raison fournie"):
    ...
    if secondes is None:
        await interaction.response.send_message(embed=firm1_embed("Format invalide", "Utilisez : `10s`, `5m`, `2h`, `1j`.", color=COLOR_ERROR), ephemeral=True); return
    if secondes > 2419200:
        await interaction.response.send_message(embed=firm1_embed("Trop long", "Maximum **28 jours**.", color=COLOR_ERROR), ephemeral=True); return
    until = discord.utils.utcnow() + datetime.timedelta(seconds=secondes)
    await membre.timeout(until, reason=raison)
    try: await membre.send(embed=firm1_embed("🔇 Vous êtes en sourdine", f"**Serveur :** {interaction.guild.name}\n**Durée :** {duree}\n**Raison :** {raison}", color=COLOR_WARNING))
    except Exception: pass
    await interaction.response.send_message(embed=firm1_embed("🔇 Membre muet", f"{membre.mention} est muet **{duree}**.", color=COLOR_WARNING, fields=[("📝 Raison", raison, True), ("🛡️ Modérateur", interaction.user.mention, True), ("⏰ Fin", f"<t:{int(until.timestamp())}:R>", True)]))
...
async def warn_cmd(interaction: discord.Interaction, membre: discord.Member, raison: str):
    ...
    try: await membre.send(embed=firm1_embed("⚠️ Avertissement reçu", f"**Serveur :** {interaction.guild.name}\n**Raison :** {raison}\n**Total :** {total}", color=COLOR_WARNING))
    except Exception: pass
...
async def warns_cmd(interaction: discord.Interaction, membre: discord.Member):
    ...
    if not warns:
        await interaction.response.send_message(embed=firm1_embed("📋 Avertissements", f"{membre.mention} n'a aucun avertissement.", color=COLOR_SUCCESS), ephemeral=True); return
...
async def clear_cmd(interaction: discord.Interaction, nombre: int):
    if not 1 <= nombre <= 100:
        await interaction.response.send_message(embed=firm1_embed("Erreur", "Entre **1** et **100**.", color=COLOR_ERROR), ephemeral=True); return
...
async def config_antispam(interaction: discord.Interaction, limite: int | None = None, fenetre: int | None = None, mute_minutes: int | None = None, actif: bool | None = None):
    if limite is not None:
        if not 2 <= limite <= 50:
            await interaction.response.send_message(embed=firm1_embed("Valeur invalide", "Limite : entre **2** et **50**.", color=COLOR_ERROR), ephemeral=True); return
        set_guild_config(interaction.guild.id, "spam_limit", limite)
    if fenetre is not None:
        if not 1 <= fenetre <= 60:
            await interaction.response.send_message(embed=firm1_embed("Valeur invalide", "Fenêtre : entre **1** et **60** secondes.", color=COLOR_ERROR), ephemeral=True); return
        set_guild_config(interaction.guild.id, "spam_window", fenetre)
    if mute_minutes is not None:
        if not 1 <= mute_minutes <= 1440:
            await interaction.response.send_message(embed=firm1_embed("Valeur invalide", "Durée : entre **1** et **1440** minutes.", color=COLOR_ERROR), ephemeral=True); return
        set_guild_config(interaction.guild.id, "spam_mute", mute_minutes)
    if actif is not None:
        set_guild_config(interaction.guild.id, "spam_active", actif)
    cfg = get_guild_config(interaction.guild.id)
    sl = cfg.get("spam_limit", SPAM_LIMIT_DEFAULT); sw = cfg.get("spam_window", SPAM_WINDOW_DEFAULT); sm = cfg.get("spam_mute", SPAM_MUTE_DEFAULT); sa = cfg.get("spam_active", True)
    await interaction.response.send_message(embed=firm1_embed("🚨 Antispam mis à jour", f"{'🟢 Activé' if sa else '🔴 Désactivé'}", color=COLOR_SUCCESS if sa else COLOR_WARNING, fields=[("📨 Seuil", f"**{sl}** messages", True), ("⏱️ Fenêtre", f"**{sw}** secondes", True), ("🔇 Sanction", f"Mute **{sm}** min", True), ("💡 Exemple", f"**{sl}+** messages en **{sw}s** → mute **{sm} min**.", False)]), ephemeral=True)
...
async def add_bad_word(interaction: discord.Interaction, mot: str):
    ...
    if ajoutes:  fields.append(("✅ Ajoutés", ", ".join(f"`{m}`" for m in ajoutes), False))
    if deja:     fields.append(("⚠️ Déjà présents", ", ".join(f"`{m}`" for m in deja), False))
...
async def remove_bad_word(interaction: discord.Interaction, mot: str):
    ...
    if mot not in bad_words:
        await interaction.response.send_message(embed=firm1_embed("Introuvable", f"`{mot}` n'est pas dans la liste.", color=COLOR_WARNING), ephemeral=True); return
...
async def list_bad_words(interaction: discord.Interaction):
    ...
    bad_words = cfg.get("bad_words", [])
    if not bad_words:
        await interaction.response.send_message(embed=firm1_embed("📋 Badwords", "Aucun mot interdit configuré.", color=COLOR_INFO), ephemeral=True); return
    mots_text = ", ".join(f"`{w}`" for w in bad_words)
    if len(mots_text) > 1000: mots_text = mots_text[:997] + "..."
...
async def wl_add(interaction: discord.Interaction, membre: discord.Member):
    ...
    if membre.id in wl:
        await interaction.response.send_message(embed=firm1_embed("Déjà présent", f"{membre.mention} est déjà whitelisté.", color=COLOR_WARNING), ephemeral=True); return
    wl.append(membre.id)
...
async def wl_remove(interaction: discord.Interaction, membre: discord.Member):
    ...
    if membre.id not in wl:
        await interaction.response.send_message(embed=firm1_embed("Introuvable", f"{membre.mention} n'est pas whitelisté.", color=COLOR_WARNING), ephemeral=True); return
    wl.remove(membre.id)
    set_guild_config(interaction.guild.id, "whitelist", wl)
...
async def bl_add(interaction: discord.Interaction, membre: discord.Member, raison: str = "Aucune raison fournie"):
    ...
    try: await membre.send(embed=firm1_embed("⛔ Vous avez été blacklisté", f"**Serveur :** {interaction.guild.name}\n**Raison :** {raison}", color=COLOR_ERROR))
    except Exception: pass
    try: await membre.kick(reason=f"Blacklisté : {raison}")
    except Exception: pass
...
async def bl_remove(interaction: discord.Interaction, membre: discord.User):
    ...
    bl  = cfg.get("blacklist", [])
    if membre.id not in bl:
        await interaction.response.send_message(embed=firm1_embed("Introuvable", f"{membre.mention} n'est pas blacklisté.", color=COLOR_WARNING), ephemeral=True); return
    bl.remove(membre.id)
    set_guild_config(interaction.guild.id, "blacklist", bl)
...
async def dice_roll(interaction: discord.Interaction, faces: int = 6):
    if faces < 2:
        await interaction.response.send_message(embed=firm1_embed("Erreur", "Au moins **2 faces**.", color=COLOR_ERROR), ephemeral=True); return
...
async def rps(interaction: discord.Interaction, choix: app_commands.Choice[str]):
    player, bot_choice = choix.value, random.choice(list(RPS_CHOICES.keys()))
    if player == bot_choice:   result, color = "Égalité !", COLOR_WARNING
    elif RPS_WINS[player] == bot_choice: result, color = "Vous gagnez ! 🎉", COLOR_SUCCESS
    else:                      result, color = "Vous perdez… 😢", COLOR_ERROR
...
EIGHTBALL_REPLIES = [
    ("✅ C'est certain.", COLOR_SUCCESS), ("✅ Oui, définitivement.", COLOR_SUCCESS), ("✅ Sans aucun doute.", COLOR_SUCCESS),
    ("✅ Oui, absolument.", COLOR_SUCCESS), ("✅ Vous pouvez compter là-dessus.", COLOR_SUCCESS),
    ("🟡 Demandez à nouveau plus tard.", COLOR_WARNING), ("🟡 Il vaut mieux ne pas répondre maintenant.", COLOR_WARNING),
...
async def guess_number(interaction: discord.Interaction, maximum: int = 100):
    ...
    if channel_id in active_guess_games:
        await interaction.response.send_message(embed=firm1_embed("Partie en cours", "Une partie est déjà en cours ici.", color=COLOR_WARNING), ephemeral=True); return
    ...
    def check(m: discord.Message): return m.channel.id == channel_id and m.content.isdigit()
    try:
        while True:
            ...
            if guess == number:
                ...
                await msg.channel.send(embed=firm1_embed("🎉 Bonne réponse !", f"{msg.author.mention} a trouvé **{number}** !", color=COLOR_SUCCESS)); break
            elif guess < number: await msg.channel.send(embed=firm1_embed("💡 Trop petit !", f"Plus grand que {guess}.", color=COLOR_WARNING), delete_after=5)
            else:                await msg.channel.send(embed=firm1_embed("💡 Trop grand !", f"Plus petit que {guess}.", color=COLOR_WARNING), delete_after=5)
...
async def trivia(interaction: discord.Interaction):
    ...
    def check(m: discord.Message): return m.channel.id == interaction.channel_id and m.author.id == interaction.user.id and m.content.upper() in ["A","B","C","D"]
    try:
...
async def on_message(message: discord.Message):
    ...
    if bot.user in message.mentions and message.content.strip() in (f"<@{bot.user.id}>", f"<@!{bot.user.id}>"):
        ...
        embed = discord.Embed(title="👾  Firm1 Bot", description="```\n  Le bot officiel de la communauté Firm1.\n  Support • Modération • Mini-Jeux\n```\nTapez `/help` pour voir toutes les commandes.\nTapez `/help <commande>` pour les détails.", color=COLOR_PRIMARY, timestamp=datetime.datetime.utcnow())
        ...
        embed.add_field(name="🔗 Commandes rapides", value="`/help` — Aide complète\n`/panel-tickets` — Panel support\n`/config-tickets` — Config tickets\n`/config-auto-mod` — Auto-mod", inline=False)
    ...
    for word in bad_words:
        ...
        if pattern.search(content_spaced):
            ...
            try: await message.author.send(embed=firm1_embed("🚫 Message supprimé", f"Votre message dans **{message.guild.name}** contient un mot interdit.", color=COLOR_ERROR))
            except Exception: pass
    ...
    # ── Images interdites ──
    if message.channel.id in cfg.get("no_image_channels", []) and (message.attachments or any(e.type in (discord.EmbedType.image, discord.EmbedType.gifv) for e in message.embeds)):
        await message.delete()
...
async def on_member_join(member: discord.Member):
    ...
    if member.id in cfg.get("blacklist", []):
        try: await member.send(embed=firm1_embed("⛔ Accès refusé", f"Vous êtes blacklisté du serveur **{member.guild.name}**.", color=COLOR_ERROR))
        except Exception: pass
